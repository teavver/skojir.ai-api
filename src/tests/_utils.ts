...
/**
 * Shortcut function for a full user setup
 * This includes: creating an account, verifying it and logging in
 * Returns userAuthTokens object on success
 */
export async function fullUserSetup(module: string, userData: IUserCredentials): Promise<UserAuthTokens> {
